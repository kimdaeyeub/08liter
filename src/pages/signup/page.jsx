    ...
    <div className="bg-[#F3F2F8] h-screen flex justify-center">
      <section className="w-[440px] mx-auto mt-[140px]">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <input
            className="bg-white w-full h-[46px] rounded-tl-[4px] rounded-tr-[4px] border border-[#CCCCCC] px-[20px] flex items-center font-medium text-sm text-[#1b1b1b] placeholder:text-[#999999]"
            type="email"
            name="email"
            id="email"
            placeholder="이메일"
          ...
          />
          {errors.email && (
            <p className="text-[#FF0101] text-sm font-medium mt-1">
              {errors.email.message}
            </p>
          )}
          <input
            className="bg-white w-full h-[46px] rounded-bl-[4px] rounded-br-[4px] border-l border-r border-b border-[#CCCCCC] px-[20px] flex items-center font-medium text-sm text-[#1b1b1b] placeholder:text-[#999999]"
            type="password"
            name="password"
            id="password"
            placeholder="비밀번호"
          ...
          <button
            type="submit"
            className="bg-[#1B1B1B] rounded-[4px] h-[60px] flex items-center justify-center w-full cursor-pointer mb-[30px]"
          >
        ...
        <button
          ...
          className="rounded-[4px] h-[60px] flex items-center justify-center w-full cursor-pointer border border-[#1B1B1B]/50"
        >
