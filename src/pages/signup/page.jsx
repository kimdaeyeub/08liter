      ...
      <section className="w-[440px] mx-auto mt-[100px]">
        ...
        >
          <div className="flex flex-col gap-[10px]">
            <label
              className="font-medium text-sm text-[#1B1B1B]"
              htmlFor="email"
            >
              이메일
            </label>
            <input
              className="bg-white w-full h-[46px] rounded-[4px] border border-[#CCCCCC] px-[14px] flex items-center font-medium text-sm text-[#1b1b1b] placeholder:text-[#999999]"
              id="email"
              type="email"
            ...
            />
            {errors.email && (
              <p className="font-medium text-base text-[#FF0101]">
          ...
          <div className="flex flex-col gap-[10px]">
            ...
            <div className="bg-white rounded-[4px] p-[16px] flex flex-col gap-[10px]">
                  ...
                  render={({ field }) => (
                    <label className="inline-flex items-center gap-2 cursor-pointer">
                      ...
                      <div className="flex gap-[10px] items-start">
                        ...
                        <span className="font-normal text-sm text-[#1B1B1B]">
                          전체 동의하기
                        </span>
                      </div>
                    </label>
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  type="button"
                  className="font-medium text-sm text-[#458EF6] underline cursor-pointer"
                >
                  전문보기
                </button>
              </div>
